const cardMock = {
  ...
  summary: {
    label:
      "Tune into Kuma Akai and his friends. Follow along the crazy adventures of these very random friends.",
  },
  "im:price": {
    label: "Get",
    attributes: {
  ...
  title: {
    label: "The Kuma Akai Podcast - The Kuma Akai Network",
  },
  link: {
    attributes: {
      rel: "alternate",
  ...
  "im:releaseDate": {
    label: "2023-07-08T00:00:00-07:00",
    attributes: {
      label: "July 8, 2023",
    },
  },
